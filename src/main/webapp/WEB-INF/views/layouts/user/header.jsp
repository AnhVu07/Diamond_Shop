            ...
            <div class="nav-collapse">
                <ul class="nav">
                    <c:forEach var="o" items="${menus}">
                        <li class="active"><a href="<c:url value="/${o.url}"/>">${o.name}</a></li>
                        </c:forEach>
                </ul>
                ...
                <ul class="nav pull-right">
                    <li class="dropdown">
                        <c:if test="${infLogin==null}">
                            ...
                            <c:if test="${infLogin!=null}">
                            <a data-toggle="" class="dropdown-toggle" href="#"><span class="icon-lock"></span> ${infLogin.displayName} <b class="caret"></b></a>
                            </c:if>
                        
                        <div class="dropdown-menu">
                            <form:form class="form-horizontal loginFrm" action="/Spring/login" method="post" modelAttribute="user">  
                                <div class="control-group">
                                    <form:input placeholder="Email" class="span2" type="email" path="user" /> 
                                </div>
                                <div class="control-group">
                                    <form:input placeholder="Password" class="span2" type="text" path="password" /> 
                                </div>
                                <div class="control-group">
