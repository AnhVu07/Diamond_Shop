            ...
            <div id="gototop"> 
                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <hr class="soft"/>
                        <div class="well">
                            <form:form class="form-horizontal" action="dang-ky" method="post" modelAttribute="user">  
                                <h3>Your Personal Details</h3>
                                <p style="color: red"class="">${sessionScope.status1}</p>
                                <div class="control-group">
                                    <label class="control-label" for="inputname">Họ và tên<sup>*</sup></label>
                                    <div class="controls">
                                        <form:input id="inputname" placeholder="Mời nhập họ và tên" type="text" path="displayName"/>  
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputEmail">Email <sup>*</sup></label>
                                    <div class="controls">
                                        <form:input id="inputEmail" type="email" placeholder="Mời nhập email" path="user"  /> 
                                    </div>
                                </div>	  
                                <div class="control-group">
                                    <label class="control-label">Password <sup>*</sup></label>
                                    <div class="controls">
                                        <form:input placeholder="Mời nhập password" type="password" path="password" /> 
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Address <sup>*</sup></label>
                                    <div class="controls">
                                        <form:input placeholder="Mời nhập địa chỉ" type="text" path="address" /> 
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                        ...
                        <div class="well">
                            <form:form class="form-horizontal" action="/Spring/login" method="post" modelAttribute="user">  
                                <h3>Login</h3>
                                <div class="control-group">
                                    <label class="control-label" for="inputEmail">Email <sup>*</sup></label>
                                    <form:input placeholder="Email"  type="email" path="user" /> 
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Password <sup>*</sup></label>
