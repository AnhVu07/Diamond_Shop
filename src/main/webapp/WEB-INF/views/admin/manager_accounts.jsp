                        ...
                        <tbody>
                            <c:forEach items="${listUser}" var="o">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<c:url value="/admin/loadAcc/${o.id}"/>"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
            ...
            <div id="addEmployeeModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form:form action="addAcc" id="myForm" method="post" modelAttribute="account">
                            ...
                            <div class="modal-body">					
                                <div class="form-group">
                                    <label>Email</label>
                                    <form:input name="user" type="email" id="email" class="form-control" path="email"></form:input>
                                    <span id="emailError" class="error" style="color: red;"></span>  
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                    <form:input name="password" type="password" id="password" class="form-control" path="password"></form:input>
                                    <span id="passwordError" class="error" style="color: red;"></span>  
                                    </div>
                                    <div class="form-group">
                                        <label>Display Name</label>
                                    <form:input name="displayName" type="text" id="displayName" class="form-control" path="displayName"></form:input>
                                    <span id="nameError" class="error" style="color: red;"></span>  
                                    </div>
                                    <div class="form-group">
                                        <label>Address</label>
                                    <form:textarea name="address" id="address" class="form-control" path="address"></form:textarea>
                                    ...
                                    <span id="roleError" class="error" style="color: red;"></span>  
                                </div>
                            </div>
                            <div class="modal-footer">
                                <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                                <input type="submit" class="btn btn-success" onclick="notificationAdd('Thêm tài khoản thành công!');" value="Add">
                            </div>
                        </form:form>
                    </div>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="deleteAcc" method="post">
                        ...
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                            <input type="submit" class="btn btn-danger" onclick="notification('Xóa tài khoản thành công!');" value="Delete">
                        </div>
                    </form>
                </div>
            </div>
