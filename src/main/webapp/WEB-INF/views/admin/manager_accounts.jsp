                        ...
                        <tbody>
                            <c:forEach items="${listUser}" var="o">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<c:url value="/loadAcc/${o.id}"/>"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a href="<c:url value="/deleteAcc/${o.id}"/>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
            ...
            <div id="addEmployeeModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form:form action="addAcc" method="post" modelAttribute="account">
                            ...
                            <div class="modal-body">					
                                <div class="form-group">
                                    <label>Email</label>
                                    <form:input name="user" type="email" class="form-control" path="user"></form:input>
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                    <form:input name="password" type="password" class="form-control" path="password"></form:input>
                                    </div>
                                    <div class="form-group">
                                        <label>Display Name</label>
                                    <form:input name="displayName" type="text" class="form-control" path="displayName"></form:input>
                                    </div>
                                    <div class="form-group">
                                        <label>Address</label>
                                    <form:textarea name="address" class="form-control" path="address"></form:textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Roles</label>
                                    <form:select id="roles" class="form-control" path="roles">
