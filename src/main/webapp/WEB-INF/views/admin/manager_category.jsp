            ...
            <div id="gototop"> 
                ...
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${listCategorys}" var="o">
                                <tr>
                                    <td>
                                        <span class="custom-checkbox">
                                    ...
                                    <td>
                                        <a href="<c:url value="/admin/loadCategory/${o.idCategory}"/>"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a href="#deleteEmployeeModal" class="delete" onclick="confirmDelete(${o.idCategory});" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
            ...
            <div id="addEmployeeModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form:form action="addCategory" id="myForm" method="post" modelAttribute="category">
                            ...
                            <div class="modal-body">					
                                <div class="form-group">
                                    ...
                                    <form:textarea name="description" id="description" class="form-control" path="description"></form:textarea>
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="submit" class="btn btn-success" onclick="notificationAdd('Thêm danh mục thành công!');" value="Add">
                            </div>
                        </form:form>
                    </div>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="deleteCategory" method="post">
                        ...
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                            <input type="submit" class="btn deleteCategory btn-danger" onclick="notification('Xóa danh mục thành công!');" value="Delete">
                        </div>
                    </form>
                </div>
            </div>
