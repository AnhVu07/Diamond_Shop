                        ...
                        <tbody>
                            <c:forEach items="${listP}" var="o">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<c:url value="/load/${o.idProducts}"/>"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a href="<c:url value="/delete/${o.idProducts}"/>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                        ...
                        <form:form action="addProduct" method="post" modelAttribute="product">
                            ...
                            <div class="modal-body">					
                                <div class="form-group">
                                    <label>Name</label>
                                    <form:input name="name" type="text" class="form-control" path="name"></form:input>
                                    </div>
                                    <div class="form-group">
                                        <label>Image</label>
                                    <form:input name="image" type="text" class="form-control" path="image"></form:input>
                                    </div>
                                    <div class="form-group">
                                        <label>Price</label>
                                    <form:input name="price" type="text" class="form-control" path="price"></form:input>
                                    </div>
                                    <div class="form-group">
                                        <label>Old Price</label>
                                    <form:input name="old_price" type="text" class="form-control" path="old_price"></form:input>
                                    </div>
                                    <div class="form-group">
                                        <label>Size</label>
                                    <form:input name="size" type="text" class="form-control" path="size"></form:input>
                                    </div>
                                    <div class="form-group">
                                        <label>Sale</label>
                                    <form:input name="sale" type="text" class="form-control" path="sale"></form:input>
                                    </div>
                                    <div class="form-group">
                                        <label>Highlight</label>
                                    <form:input name="highlight" type="text" class="form-control" path="highlight"></form:input>
                                    </div>
                                    <div class="form-group">
                                        <label>New Product</label>
                                    <form:input name="newProduct" type="text" class="form-control" path="newProduct"></form:input>
                                    </div>
                                    <div class="form-group">
                                        <label>Title</label>
                                    <form:textarea name="title" class="form-control" path="title"></form:textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Description</label>
                                    <form:textarea name="description" class="form-control" path="detail"></form:textarea>
                                    </div>
                                    <div class="form-group">
