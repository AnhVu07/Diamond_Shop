                    ...
                    <div class="well">
                        <form:form class="form-horizontal" action="checkout" method="post" modelAttribute="bill">  
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <form:input placeholder="Mời nhập họ và tên" type="text" path="displayName" /> 
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Email<sup>*</sup></label>
                                <div class="controls">
                                    <form:input placeholder="Email" type="text" path="users" />
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <form:input placeholder="Liên hệ" type="text" path="phone" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Phương thức thanh toán<sup>*</sup></label>
                                <div class="controls">
                                    <form:input type="text" path="" value="Thanh toán khi nhận hàng" readonly="true"  />
                                </div>
                            </div>
                            <div class="control-group">
